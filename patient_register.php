					...
					<form action="" method="POST" id="myform">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="InputWithIcon">
										<input type="text" name="unit" id="unit" class="form-control form-control-lg" placeholder="enter the unit" required="true">
										<i class="fa fa-tint"></i>
									</div>
								</div>	
							</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-lg-6">
									<label for="last_date" class="lbl_name">Last Date:</label>
								</div>
								<div class="col-lg-6">
									<div class="InputWithIcon">
