			...
			if ($con->connect_error) {
				die('connection failed'.$con->connect_error);
					...
					elseif (!preg_match("/^\d{10}+$/", $re_mob)) {
						...
						$sql="INSERT INTO `patient`(`pat_name`, `pat_age`, `reason`, `bloood_grp`, `act_mobile`, `rel_name`, `rel_mobile`, `hospital_name`,`unit`,`last_date`) VALUES ('$pat_name','$pat_age','$reason','$blod_grp','$act_mob','$re_name','$re_mob','$hosp','$unit','$last_date')";
